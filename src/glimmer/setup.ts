...
import BottomNavigation from './native-components/BottomNavigation/component';
import BottomNavigationTemplate from './native-components/BottomNavigation/template';
...
export default function setupGlimmer(resolverDelegate: ResolverDelegate, resolver: Resolver) {
    ...
    registerNativeComponent(resolver, resolverDelegate, 'BottomNavigation', BottomNavigation, BottomNavigationTemplate);
    ...
    registerNativeComponent(resolver, resolverDelegate, 'TabView', TabStrip, TabStripTemplate);
    registerNativeComponent(resolver, resolverDelegate, 'TabView', TabStripItem, TabStripItemTemplate);
